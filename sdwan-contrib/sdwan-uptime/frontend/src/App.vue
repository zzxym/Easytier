  ...
  <div id="app">
    ...
    <el-header class="app-header">
      <div class="header-content">
        <div class="logo-section">
          ...
          <h1 class="app-title">SDWAN Uptime</h1>
        </div>
        ...
        <div class="header-actions">
          ...
          <!-- GitHub链接 -->
          <el-button type="primary" link @click="() => openExternalLink('https://github.com/zzxym/sdwan')">
            <el-icon>
              <Link />
            </el-icon>
            GitHub
    ...
    <el-footer class="app-footer">
      <div class="footer-content">
        <p>
          © 2024 SDWAN Community |
          <el-button type="primary" link size="small"
            @click="() => openExternalLink('https://github.com/zzxym/sdwan')">
            开源项目
          </el-button>
          |
          <el-button type="primary" link size="small"
            @click="() => openExternalLink('https://github.com/zzxym/sdwan/blob/main/README.md')">
            使用文档
          </el-button>
        </p>
      </div>
