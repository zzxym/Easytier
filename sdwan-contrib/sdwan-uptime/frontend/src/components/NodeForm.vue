  ...
  <div>
    <el-form ref="formRef" :model="form" :rules="rules" label-width="120px" label-position="left"
      ...
      <el-form-item label="网络名称" prop="network_name" required>
        <el-input v-model="form.network_name" placeholder="请输入SDWAN网络名称" maxlength="100" clearable>
          <template #prefix>
            <el-icon>
              <Connection />
            </el-icon>
        ...
        <div class="form-tip">与 SDWAN 的 network name 一致，用于后端探活</div>
      </el-form-item>
      ...
      <el-form-item label="网络密码" prop="network_secret" required>
        ...
        <div class="form-tip">与 SDWAN 的 network secret 一致</div>
      </el-form-item>
