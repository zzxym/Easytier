    ...
    return [...devices].sort((a, b) => {
        ...
        switch (sortField) {
            case 'hostname':
                ...
                break;
            case 'version':
                result = a.sdwan_version.localeCompare(b.sdwan_version);
                break;
            case 'networks':
                ...
                <div v-for="device in sortedDeviceList" :key="device.machine_id" class="device-card">
                    ...
                    <div class="card-header">
                        ...
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <!-- 版本徽章 -->
                            <div class="text-xs version-badge" v-tooltip="`SDWAN ${device.sdwan_version}`">
                                v{{ device.sdwan_version.split('-')[0] }}
                            </div>
                        </div>
