...
import SdwanFrontendLib from 'sdwan-frontend-lib'
...
).use(ToastService as any).use(DialogService as any).use(router).use(ConfirmationService as any).use(SdwanFrontendLib).mount('#app')
