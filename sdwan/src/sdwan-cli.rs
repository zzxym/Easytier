...
enum ServiceSubCommand {
    #[command(about = "register sdwan-core as a system service")]
    Install(InstallArgs),
    #[command(about = "unregister sdwan-core system service")]
    Uninstall,
    #[command(about = "check sdwan-core system service status")]
    Status,
    #[command(about = "start sdwan-core system service")]
    Start,
    #[command(about = "stop sdwan-core system service")]
    Stop,
}
