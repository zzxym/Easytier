...
declare global {
  ...
  const getsdwanVersion: typeof import('./composables/network')['getsdwanVersion']
...
declare module 'vue' {
  ...
  interface ComponentCustomProperties {
    ...
    readonly getSdwanVersion: UnwrapRef<typeof import('./composables/network')['getSdwanVersion']>
